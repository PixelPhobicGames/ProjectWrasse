...
#define NoColour  CLITERAL(Color){ 0 , 0 , 0 , 0} 
...
static RenderTexture2D ShadowTarget;
static Vector2 ShadowResolution = {160 , 100};
...
class EngineData {
  public:
    ...
    void InitCamera() {
        ...
        ShadowCamera.target = (Vector3){ 199.943 ,80.1653 , 193.077};
        ShadowCamera.position = (Vector3){ 200.000f, 500.14f, 200.0f};
        ShadowCamera.up = (Vector3){0.0f, 1.0f,0.0f};
        ShadowCamera.projection = CAMERA_PERSPECTIVE;
    }
};
