...
static Texture2D FacialExpression;
...
void InitObjects() {
    ...
    OmegaTechGameObjects.ClickNoise = LoadSound("GameData/Global/Sounds/Click.mp3");
    ...
    if (IsPathFile("GameData/Global/Objects/Object1.obj")) {
        ...
        OmegaTechGameObjects.Object1.materials[0].maps[MATERIAL_MAP_DIFFUSE].texture =
            OmegaTechGameObjects.Object1Texture;
    ...
    if (IsPathFile("GameData/Global/Objects/Object2.obj")) {
        ...
        OmegaTechGameObjects.Object2.materials[0].maps[MATERIAL_MAP_DIFFUSE].texture =
            OmegaTechGameObjects.Object2Texture;
    ...
    if (IsPathFile("GameData/Global/Objects/Object3.obj")) {
        ...
        OmegaTechGameObjects.Object3.materials[0].maps[MATERIAL_MAP_DIFFUSE].texture =
            OmegaTechGameObjects.Object3Texture;
    ...
    if (IsPathFile("GameData/Global/Objects/Object4.obj")) {
        ...
        OmegaTechGameObjects.Object4.materials[0].maps[MATERIAL_MAP_DIFFUSE].texture =
            OmegaTechGameObjects.Object4Texture;
    ...
    if (IsPathFile("GameData/Global/Objects/Object5.obj")) {
        ...
        OmegaTechGameObjects.Object5.materials[0].maps[MATERIAL_MAP_DIFFUSE].texture =
            OmegaTechGameObjects.Object5Texture;
...
void UpdateUI() {
    DrawTexturePro(OmegaTechGameObjects.ObjectBar,
                   (Rectangle){0, 0, OmegaTechGameObjects.ObjectBar.width, OmegaTechGameObjects.ObjectBar.height},
                   (Rectangle){0, 0, float(GetScreenWidth()), float(GetScreenHeight())},
                   (Vector2){0, 0},
                   0.f,
                   WHITE);

    DrawTexturePro(FacialExpression,
                   {0, 0, FacialExpression.width, FacialExpression.height},
                   {31, 320, 205, 195},
                   {0, 0},
                   0,
                   WHITE);
    ...
    // DrawRectangleLines(10 + 2 + ((SelectedObject - 1) * 96) - ((SelectedObject
    // * 3)) ,  GetScreenHeight() - 5 - (32 * 3) , 32*3, 32*3, WHITE);

    /*

    if (OmegaTechGameObjects.Object1Owned){
        DrawTextureEx(OmegaTechGameObjects.Object1Icon, {10, GetScreenHeight() - 5
    - (32 * 3)} , 0 , 3, WHITE); if (SelectedObject ==
    1)DrawTextEx(OmegaTechGameObjects.BarFont, TextFormat("%ls" ,
    OmegaTechGameObjects.Object1Name.c_str() ),{ 10, (GetScreenHeight() - 5 - (32
    * 3)) - 20 } , 20 , 1, WHITE);
    }

    if (OmegaTechGameObjects.Object2Owned){
        DrawTextureEx(OmegaTechGameObjects.Object2Icon, {10 + (32 * 3),
    GetScreenHeight() - 5 - (32 * 3)} , 0 , 3, WHITE); if (SelectedObject ==
    2)DrawTextEx(OmegaTechGameObjects.BarFont, TextFormat("%ls" ,
    OmegaTechGameObjects.Object2Name.c_str() ),{ 10 + 96, (GetScreenHeight() - 5 -
    (32 * 3)) - 20 } , 20 , 1, WHITE);
    }

    if (OmegaTechGameObjects.Object3Owned){
        DrawTextureEx(OmegaTechGameObjects.Object3Icon, {10 + 96 * 2,
    GetScreenHeight() - 5 - (32 * 3)} , 0 , 3, WHITE); if (SelectedObject ==
    3)DrawTextEx(OmegaTechGameObjects.BarFont, TextFormat("%ls" ,
    OmegaTechGameObjects.Object3Name.c_str() ),{ 10 + 96 * 2, (GetScreenHeight() -
    5 - (32 * 3)) - 20 } , 20 , 1, WHITE);
    }

    if (OmegaTechGameObjects.Object4Owned){
        DrawTextureEx(OmegaTechGameObjects.Object4Icon, {10+ 96 * 3,
    GetScreenHeight() - 5 - (32 * 3)} , 0 , 3, WHITE); if (SelectedObject ==
    4)DrawTextEx(OmegaTechGameObjects.BarFont, TextFormat("%ls" ,
    OmegaTechGameObjects.Object4Name.c_str() ),{ 10 + 96 * 3, (GetScreenHeight() -
    5 - (32 * 3)) - 20 } , 20 , 1, WHITE);
    }

    if (OmegaTechGameObjects.Object5Owned){
        DrawTextureEx(OmegaTechGameObjects.Object5Icon, {10+ 96 * 4,
    GetScreenHeight() - 5 - (32 * 3)} , 0 , 3, WHITE); if (SelectedObject ==
    5)DrawTextEx(OmegaTechGameObjects.BarFont, TextFormat("%ls" ,
    OmegaTechGameObjects.Object5Name.c_str() ),{ 10 + 96 * 4, (GetScreenHeight() -
    5 - (32 * 3)) - 20 } , 20 , 1, WHITE);
    }
    ...
    */
    ...
    if (IsMouseButtonPressed(0)) {
        PlaySound(OmegaTechGameObjects.ClickNoise);
    }
}